-- Perfomance analysis
/* Analyze the year perfomance of products by comparing each product's sales to both its
average sales perfomance and previous year's sales.
*/
